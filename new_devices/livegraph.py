...
def update_Graph():
    ...
    liveGraph.plot(timeVector,dataVector[:,1])
    liveGraph.plot(timeVector,dataVector[:,2])
    liveGraph.plot(timeVector,dataVector[:,3])
    liveGraph.plot(timeVector,dataVector[:,4])
    app.processEvents()
